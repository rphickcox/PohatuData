...
pkgs <- c("knitr", "kableExtra", "broom", "janitor", "here", 
...
yr <- ifelse(month(today()) > 7, year(today()), year(today())-1) # yr
...
source("../ALL_CODE/gd_functions.R")

# Replace spaces with underscores in column names
monitor <- clean_monitor(monitor)
nestid <- clean_nestid(nestid)
birdid <- clean_birdid(birdid)
```
