...
monitoring_past <- bind_rows(lapply(list.files("./../ALL_DATA/Data", pattern = "Monitoring_20", full.names = TRUE,
                              recursive = TRUE, include.dirs = TRUE), 
                   read_excel))
...
weights_age <- weights_time_total %>%
  mutate(Days_old = (DateTime - HatchDate)/86400, 
...
ggsave("./../ALL_DATA/Data/Chickweights_byage.png", bg = "white")
...
ggsave("./../ALL_DATA/Data/Chickweights_meanbyage.png", bg = "white")
```
