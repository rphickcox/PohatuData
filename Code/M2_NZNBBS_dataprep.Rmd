...
```{r breedingsum}
breeding <- read_excel("../ALL_DATA/Data/2025-2026/BreedingSeason_2025_finalsummary_edited.xlsm")
breeding <- breeding %>% 
...
write.xlsx(all, "../ALL_DATA/Data/2025-2026/NZNBBS_PohatuPenguins_2025_2026_R.xlsx", rowNames = FALSE)
```