...
pkgs <- c("rgdal", "rgeos", "raster", "knitr", "kableExtra", "broom", "sf",
          "readxl", "flextable", "terra", "lubridate", "tidyverse", "openxlsx", 
          "leaflet", "htmltools", "htmlwidgets", "leaflet.extras")
...
nestid <- read.csv("./../ALL_DATA/Data/Nest ID.csv")
nbhoods_wgs <- st_read("../ALL_DATA/Mapping/Neighbourhoods/all_neighbourhoods_wgs.shp")
nbhoods_wgs <- st_zm(nbhoods_wgs, drop = T, what = "ZM") #drop extra dimensions
nestbox_wgs <- nestbox_wgs %>% 
  mutate(Neighborho = str_replace_all(Neighborho, "Dagobah System", "The Dagobah System"), 
         Neighborho = str_replace_all(Neighborho, "Unnamed Land", "The Unnamed Land"))
```
...
saveWidget(map, file = "Maps/nbhood_nest_map.html")
