...
folder_out <- "C:/Users/rphic/OneDrive/Documents/Pohatu_data/Breeding_2024_clean"
...
sa_bb <- st_transform(sa_bb, crs = 4326)
sa_bb <- st_bbox(sa_bb)
 ...
 #basemap_gglayer(sa_bb) +
  ...
  geom_sf(
    ...
    mapping = aes(geometry = geometry,
                  color = id), alpha = 0.9) +
  facet_wrap(vars(season, year), nrow = 3) +
  labs(x = "Longitude", y = "Latitude") +
  scale_color_viridis_d() +
  guides(color = guide_legend(title = "Bird ID", theme(legend.title.position = "top"), 
                         nrow = 2, byrow = TRUE)) +
  ggspatial::annotation_north_arrow(location = "bl", data = subset(sf_lines, season == "POSTGUARD"), text_col = "white") +
  ggspatial::annotation_scale(location = "br", data = subset(sf_lines, season == "POSTGUARD"), text_col = "white") +
